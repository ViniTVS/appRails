...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { ano: @livro.ano, editora_id: @livro.editora_id, nome: @livro.nome } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { ano: @livro.ano, editora_id: @livro.editora_id, nome: @livro.nome } }
